...
const HeroContainer: FunctionComponent = () => {
  const [datesFieldDateTimePickerValue, setDatesFieldDateTimePickerValue] =
    useState(null);
  const [datesFieldDateTimePicker1Value, setDatesFieldDateTimePicker1Value] =
    useState(null);
  return (
          ...
          <div className={styles.frameParent}>
            ...
            <div className={styles.form}>
              ...
              <div className={styles.grouped}>
                ...
                <div className={styles.datesField1}>
                  <DatePicker
                    value={datesFieldDateTimePicker1Value}
                    onChange={(newValue: any) => {
                      setDatesFieldDateTimePicker1Value(newValue);
                    }}
                    sx={{
                      fieldset: {
                        borderColor: "#d9d9d9",
